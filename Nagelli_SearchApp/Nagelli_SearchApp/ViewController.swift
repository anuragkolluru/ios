...
//  Nagelli_SearchApp
//
//  Created by Nagelli,Sai Kiran Reddy on 3/3/22.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        rsltImage.image = UIImage(named: "hello")
    ...
    var animal_title = ["Iron Man","Captain America","Thor","Wonder Woman","Captain Marvel","Doctor Strange"]
    var bike_title = ["Lamborghini","Ferrari","Audi","Rolls Royce","Mustang","BMW"]
    var place_title = ["Biryani","Sambar","Shawarma","Panner Butter Masala","Thali","Ice Cream"]
    
    var array_img = [["iron-man","captain-america","thor","wonder-woman","captain-marvel","doctor-strange"],["lamborghini","ferrari","audi","rolls-royce","mustang","bmw"],["biryani","sambar","shawarma","paneer","thali","ice-cream"]]
    
    var array_topics = ["actors","cars","meals"]
    
    var animal_keywords = ["actor","actors","hero","protagonist","celebrities"]
